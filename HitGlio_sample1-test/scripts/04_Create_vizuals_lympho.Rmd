...
myelo_cluster_annotation["1"] <- "[C1]"
myelo_cluster_annotation["2"] <- "[C2]"
myelo_cluster_annotation["3"] <- "[C1]"
myelo_cluster_annotation["4"] <- "[C3]"
myelo_cluster_annotation["5"] <- "[C4]"
myelo_cluster_annotation["6"] <- "[C5]"
myelo_cluster_annotation["7"] <- "[C6]"
myelo_cluster_annotation["8"] <- "[C7]"
myelo_cluster_annotation["9"] <- "[C8]"
myelo_cluster_annotation["10"] <- "[C8]"
myelo_cluster_annotation["11"] <- "[C9]"
myelo_cluster_annotation["12"] <- "[C10]" # nolint
myelo_cluster_annotation["13"] <- "[C11]"
myelo_cluster_annotation["14"] <- "[C12]"
myelo_cluster_annotation["15"] <- "[C13]"
myelo_cluster_annotation["16"] <- "[C14]"
...
# Cycling cells
```{r}
colnames(seu_singlet_lympho@meta.data)
